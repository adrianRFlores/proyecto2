...
<nav style="position: absolute;
	...
	text-align: left;
	color: white;">
<h1 align="center">Seleccione si la oración utiliza de forma correcta las tíldes:</h1>
<form action="pr.php" method="POST">
<p>1. Manuel estudia mecanica. </p>
