...
<nav style="position: absolute;
	...
	text-align: left;
	color: white;">
<h1 align="center">Seleccione si la oración utiliza de forma correcta la s, c y z:</h1>
<form action="pr.php" method="POST">
<p>1. Las luzes son muy bonitas. </p>
