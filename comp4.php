...
<html>
<head>
	<title>Comprobación lectora los 3 cerditos</title>
...
<p>1. ¿Cuantos cerditos eran?</p>
<input style = "width:5%" type="radio" id="cb1" name="cb1" value="0"><label>A. 1</label><br>
<input style = "width:5%" type="radio" id="cb1" name="cb1" value="0"><label>B. 2</label><br>
<input style = "width:5%" type="radio" id="cb1" name="cb1" value="1"><label>C. 3</label><br>



<p>2. ¿La casa de paja fue destruida ?</p>
...
<p>3. ¿La casa de ladrillo fue destruida? </p>
